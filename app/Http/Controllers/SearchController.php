...
class SearchController extends Controller
{
    ...
    public function searchFriend(Request $request)
    {
        ...
        // select * from users join participants on users.id=participants.user_id  join conversation on participants.conversation_id= conversation.id
        // where conversation.id in ( select conversation_id from users join participants on users.id= participants.user_id where users.id=6) and (conversation.title like '%b%'
        // or participants.title like '%b%')
